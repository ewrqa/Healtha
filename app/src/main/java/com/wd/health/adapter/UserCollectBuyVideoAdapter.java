 ...
 * @date 2022/7/25
 */
public class UserCollectBuyVideoAdapter extends CommonAdapter<UserBuyVideoBean.ResultBean> {
    public UserCollectBuyVideoAdapter(Context context, int layoutId, List<UserBuyVideoBean.ResultBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, UserBuyVideoBean.ResultBean resultBean, int position) {
        //获取本地的时间
