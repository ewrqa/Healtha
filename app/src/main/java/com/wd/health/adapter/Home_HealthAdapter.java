 ...
 * @date 2022/7/16
 */
public class Home_HealthAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<HealthInFormtionMessageBean.ResultBean>list;
    private  Context context;
    private String[] split;

    public Home_HealthAdapter(List<HealthInFormtionMessageBean.ResultBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)){
            ...
            case 0:
                ...
                nullHolder.name0.setText(list.get(position).getSource());

                nullHolder.time0.setText(list.get(position).getReleaseTime()+"");
            break;
            case 1:
                ...
                oneHodler.name1.setText(list.get(position).getSource());

                oneHodler.time1.setText(list.get(position).getReleaseTime()+"");
            ...
            case  3:
                ...
                threadHolder.name3.setText(list.get(position).getSource());

                threadHolder.time3.setText(list.get(position).getReleaseTime()+"");
